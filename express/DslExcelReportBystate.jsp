<%-- 
    Document   : DslExcelReportBystate
    Created on : May 24, 2011, 12:38:37 PM
    Author     : satish.t
--%>
...
<%
            ...
            response.setHeader("Content-Disposition", "attachment; filename=" + "DslReportBystate" + ".xls");
