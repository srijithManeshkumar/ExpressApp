<%-- 
    Document   : PreorderExcelReport
    Created on : May 24, 2011, 11:53:42 AM
    Author     : satish.t
--%>
<%@ page language="java"
...
<%
            ...
            response.setHeader("Content-Disposition", "attachment; filename=" + "PreorderReport" + ".xls");
    ...
    <%
                ...
                while (rs.next() == true) {
                    ...
                    String strOCNQuery =
                            ...
                            + " AND PH2.PRE_ORDR_STTS_CD_IN = 'COMPLETED' AND P.ICARE = 'N' "
