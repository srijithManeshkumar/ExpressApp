 ...
 * 
 * DESCRIPTION: User statistics/performance report for Billing Disputes. User picks a date
 *		range from UserRptDateSelect.jsp. The user can also optionally pick to
 *		run rpt for a specific userid.
 * 
 * AUTHOR:      pjs
 * 
 * DATE:        05/29/2003
