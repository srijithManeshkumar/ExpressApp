 ...
 */
/** 
 * MODULE:	MonthlyReport.jsp	
 * 
 * DESCRIPTION: Monthly report for all OCNs - that includes various statistics on the number of
*       requests submitted, etc by day of week (week ending date).
 * 
 * AUTHOR:      psedlak
 * 
 * DATE:        01-02-2002
 * 
 * HISTORY:
 * 02/05/2008  HD0000002472840 Steve Korchnak - added column for simple port orders
 *	02/11/2002  psedlak Release 1.1 Revised per client requirements
 *	01/08/2003  psedlak SER 20477
 *
 */

/* $Log:   //ACI-AIS-PVCS/SCM2PVCS/PVCS/ARCHIVES/express/JAVA/JSP/MonthlyReport.jsv  $
/*
/*   Rev 1.2   18 Feb 2002 12:15:50   sedlak
/* 
/*
/*   Rev 1.1   31 Jan 2002 13:38:30   sedlak
/* 
/*
/*   Rev 1.0   31 Jan 2002 07:04:02   sedlak
/*Initial revision
/*
/*   Rev 1.0   31 Jan 2002 07:00:18   psedlak
/*Initial Checkin
*/
...
%>
		...
		<table id="MRLSRTable" class="tablesorter" width="90%" border=1 align=center cellspacing=0 cellpadding=1>
                    <thead>
