 ...
 * MODULE:	WGInterval.jsp	
 * 
 * DESCRIPTION: Business Data Product, work group interval report
 * 
 ...
 * 
 * HISTORY:
 * 01/02/2006	Steve Korchnak	RREQ00000001769 added processing to generate worksheet output.
 */
%>
...
<%
	...
	if (Integer.parseInt(strWGReportType[0]) == 2)
	{
		Log.write(Log.DEBUG_VERBOSE, "WG Interval Report: Date:" + strStartDate + " Date:" + strEndDate);
...
<%
	...
	else if (Integer.parseInt(strWGReportType[0]) == 3)
	{
%>
		<jsp:forward page="WGIntrvlWS.jsp"/>;
<%
	}
%>
</UL>
