 ...
 */
/** 
 * MODULE:	DwoErrorView.jsp	
 * 
 * DESCRIPTION: Displays dwo errors
 * 
 * AUTHOR:      dmartz
 * 
 * DATE:        03-20-2004
...
<%
Log.write(Log.DEBUG_VERBOSE, "DwoErrorView.jsp --- ");
%>
<BR>
<BR>
<P align=center>An Error has occurred with the Transaction you attempted.</P>
<BR>
<p align=center>The Dwo may have been updated by another user.<BR><center>OR<br>
