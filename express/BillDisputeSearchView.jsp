 ...
 */
/** 
 * MODULE:	BillDisputeSearchView.jsp	
 * 
 * DESCRIPTION: 
 * 
 * AUTHOR:	Vince Pavill      
...
<FORM NAME="BillDisputeSearchView" METHOD=POST ACTION="BillDisputeListCtlr?dsptsrch=advsrch">

<TABLE width=70% align=center cellspacing=0 cellpadding=0 border=0>
  <TR><TD colspan=2>&nbsp;</TD></TR>
  <TR><TD align=center colspan=2><SPAN CLASS="header1">S&nbsp;E&nbsp;A&nbsp;R&nbsp;C&nbsp;H&nbsp;&nbsp;&nbsp;&nbsp;D&nbsp;I&nbsp;S&nbsp;P&nbsp;U&nbsp;T&nbsp;E&nbsp;S</SPAN></TD></TR>
  <TR><TD colspan=2>&nbsp;</TD></TR>
  <TR><TD colspan=2>&nbsp;</TD></TR>
  <TR>
	<TD align=right valign=top>Dispute&nbsp;Number:&nbsp;</TD>
	<TD align=left><input type=text maxLength=16 size=25 name=ttn><BR><BR></TD>
  </TR>
  <TR>
	<TD align=right valign=top>BTN:</TD>
	<TD align=left><input type=text maxLength=17 size=17 name=teleno><BR><BR></TD>
  </TR>
  <TR>
	<TD align=right valign=top>Dispute Status:&nbsp;</TD>
	<TD align=left>
	<input type="checkbox" name="dispute_status" value="">ALL
	<br>
	<%
	rsSrch = stmtSrch.executeQuery("SELECT STTS_CD FROM STATUS_T WHERE TYP_IND = 'B' ORDER BY STTS_CD ASC");

	while (rsSrch.next() == true)
	{
	%>
		<input type="checkbox" name="dispute_status" value=<%= rsSrch.getString("STTS_CD") %>><%= rsSrch.getString("STTS_CD") %>
		<br>
	<%
	}
	%>
