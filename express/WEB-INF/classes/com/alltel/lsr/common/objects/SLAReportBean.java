 ...
 */
/** 
 * MODULE:	SLAReportBean.java
 * 
 * DESCRIPTION: SLA report bean - cloned SLA report into this object to be able to run &
...
public class SLAReportBean
{
	public SLAReportBean()
	{	
		m_strStartYr="2005";
		m_strStartMth="";
		m_strStartDay="01";
	...
	nstrBuff.append("<br><table border=1 align=center cellspacing=0 cellpadding=1>" +
		...
		while(rs.next()==true) 
		{
			...
			String strOCNQuery =
			  ...
			  " R.CMPNY_SQNC_NMBR=" + strCmpnySqncNmbr + strSRVC_TYP_CD_Where + strOrderFlagWhere +
