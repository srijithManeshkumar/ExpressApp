...
%>
			<td align=center
				...
				<INPUT TYPE="SUBMIT" NAME="notes" VALUE="Internal Notes">
			</td>
<%		}
%>
	<td align=center
		<%if (strHist != null) 
			 { if (strHist.equals("History"))
				{ %> bgcolor=yellow <% }} %> >
		<INPUT TYPE="SUBMIT" NAME="hist" VALUE="History">
	</td>
...
%>				
			>
			<INPUT TYPE="SUBMIT" NAME="dslform" VALUE="<%=rsHdr.getString("FRM_CD")%>">
			</td>
<% 
		} //while()
		rsHdr.close();
...
%>
	...
	<td valign=top>
	  <table align=right border=0 bordercolor="#cccccc" cellspacing=1 cellpadding=2>
        <tr>
		  <td>&nbsp;</td>
<%
...
%>
							<td align=center>
							<INPUT TYPE="SUBMIT" NAME="action" VALUE="<%=strAction%>" <%=strConfirmationText%> >
							</td>
<% 
						}
					}
