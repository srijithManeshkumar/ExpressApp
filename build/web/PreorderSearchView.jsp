 ...
 */
/** 
 * MODULE:	PreorderSearchView.jsp	
 * 
 * DESCRIPTION: JSP View used to search the Preorder List
 * 
...
<FORM NAME="PreorderSearchView" METHOD=POST ACTION="PreorderListCtlr?presrch=advsrch">

<TABLE width=70% align=center cellspacing=0 cellpadding=0 border=0>
  <TR><TD colspan=2>&nbsp;</TD></TR>
  <TR><TD align=center colspan=2><SPAN CLASS="header1">S&nbsp;E&nbsp;A&nbsp;R&nbsp;C&nbsp;H&nbsp;&nbsp;&nbsp;&nbsp;P&nbsp;R&nbsp;E&nbsp;O&nbsp;R&nbsp;D&nbsp;E&nbsp;R</SPAN></TD></TR>
  <TR><TD colspan=2>&nbsp;</TD></TR>
  <TR><TD colspan=2>&nbsp;</TD></TR>
  <TR>
	<TD align=right>TXNUM:&nbsp;</TD>
	<TD align=left><input type=text maxLength=16 size=25 name=txnum><BR><BR></TD>
  </TR>
  <TR>
	<TD align=right valign=top>PreOrder&nbsp;Status:&nbsp;</TD>
	<TD align=left>
	<input type="checkbox" name="status" value="">ALL
	<br>
	<%
	rsSrch = stmtSrch.executeQuery("SELECT STTS_CD FROM STATUS_T WHERE TYP_IND = 'P' ORDER BY STTS_CD ASC");

	while (rsSrch.next() == true)
	{
	%>
		<input type="checkbox" name="status" value=<%= rsSrch.getString("STTS_CD") %>><%= rsSrch.getString("STTS_CD") %>
		<br>
	<%
	}
	%>
  ...
  <TR>
	<TD align=right valign=top>PreOrder&nbsp;Transaction&nbsp;Type:</TD>
	<TD align=left>
	<input type="checkbox" name="srvc_type" value="">ALL
	<br>
	<%
	rsSrch = stmtSrch.executeQuery("SELECT SRVC_TYP_CD, SRVC_TYP_DSCRPTN FROM SERVICE_TYPE_T WHERE TYP_IND = 'P' ORDER BY SRVC_TYP_DSCRPTN ASC");
  ...
  <TR>
	...
	<br>
	<%
	rsSrch = stmtSrch.executeQuery("SELECT ACTVTY_TYP_CD, ACTVTY_TYP_DSCRPTN FROM ACTIVITY_TYPE_T WHERE TYP_IND = 'P' ORDER BY ACTVTY_TYP_DSCRPTN ASC");
  ...
  <TR>
	<TD align=right>From&nbsp;Date&nbsp;Sent&nbsp;<i>(MM/DD/YYYY)</i>&nbsp;:</TD>
	<TD align=left>
	<input type="TEXT" size=3 maxLength=2 NAME="from_date_sent_mnth" VALUE="">
	/
	<input type="TEXT" size=3 maxLength=2 NAME="from_date_sent_dy" VALUE="">
	/
	<input type="TEXT" size=5 maxLength=4 NAME="from_date_sent_yr" VALUE="">
	&nbsp;&nbsp;&nbsp;To&nbsp;Date&nbsp;Sent&nbsp;<i>(MM/DD/YYYY)</i>&nbsp;:
	<input type="TEXT" size=3 maxLength=2 NAME="to_date_sent_mnth" VALUE="">
	/
	<input type="TEXT" size=3 maxLength=2 NAME="to_date_sent_dy" VALUE="">
	/
	<input type="TEXT" size=5 maxLength=4 NAME="to_date_sent_yr" VALUE="">
	</TD>
  </TR>
  <TR>
