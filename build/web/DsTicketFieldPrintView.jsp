 ...
 */
/** 
 * MODULE:	DsTicketFieldPrintView.jsp
 * DESCRIPTION: 
...
catch (Exception e)
{
	...
	Log.write(Log.ERROR, "Trapped in DsTicketFieldPrintView.jsp");
}
%>
...
<%
Log.write(Log.DEBUG_VERBOSE, "DsTicketFieldPrintView.jsp --- ");
%>
...
m_strErrVldQry = "SELECT DISTINCT FRM_SQNC_NMBR FROM DSTICKET_T, SERVICE_TYPE_FORM_T WHERE TCKT_SQNC_NMBR = " + 
