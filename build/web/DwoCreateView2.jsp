...
<TABLE width=70% align=center cellspacing=0 cellpadding=0 border=0>
  ...
  <TR><TD align=center colspan=4><SPAN CLASS="header1">C&nbsp;R&nbsp;E&nbsp;A&nbsp;T&nbsp;E&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;O&nbsp;R&nbsp;D&nbsp;E&nbsp;R</SPAN></TD></TR>
  <TR><TD colspan=4>&nbsp;</TD></TR>
...
<%
    ...
    Log.write("Exception in DwoCreateView2.jsp : "+e.getMessage());
	...
	stmtRC=null;
        ...
        Log.write("Releasing connection object in DwoCreateView2.jsp for conn object: "+conRC.toString());
	DatabaseManager.releaseConnection(conRC);
        Log.write("After releasing connection object in DwoCreateView2.jsp.");   
