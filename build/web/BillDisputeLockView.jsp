 ...
 */
/** 
 * MODULE:		BillDisputeLockView.jsp
 * 
 * DESCRIPTION: Displays a list of locked billdisputes and provides a link to unlock it.
 * 
 * AUTHOR:      Vince Pavill
 * 
 * DATE:        01-21-2003
...
<%
	final String SECURITY_OBJECT = "UNLOCK_TICKETS";
...
<table align=center width="100%">
  <tr>
	...
	<SPAN class="barheader">Billing&nbsp;Dispute&nbsp;Locks</SPAN>
    </th>
  </tr>
</table>
<BR CLEAR=ALL>
...
<TH align=center>Dispute&nbsp;Number</TH>
...
<%
	String strQuery = "SELECT TL.SQNC_NMBR, TL.USERID,  " +
		...
		" FROM LOCK_T TL, USERID_T U, DISPUTE_T T, OCN_T O " +
		" WHERE TL.USERID = U.USERID AND TL.SQNC_NMBR = T.DSPT_SQNC_NMBR AND TL.TYP_IND = 'B'" +
		" AND T.OCN_CD = O.OCN_CD " +
		" ORDER BY T.DSPT_SQNC_NMBR ASC";
...
%>
		<TR>
			...
			<TD align=center><A HREF="BillDisputeUnlockCtlr?dspt=<%=rs.getString(1)%>">&nbsp;Unlock&nbsp;Dispute&nbsp;</A></TD>
