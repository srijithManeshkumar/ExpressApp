<%
             ...
             */
            /**
             * MODULE:	AutoDetailDateSelect.jsp
             *
             * DESCRIPTION: JSP View used to select dates for the Automated Activity Daily Detail Report
             *
             * AUTHOR:      Andy Wei
             *
             * DATE:        09-15-2009
...
<%            final String SECURITY_OBJECT = "PROV_REPORTS";
            ...
            Log.write(Log.DEBUG_VERBOSE, "DailyDetailReport parm rpt=" + strPost);
%>
<script language="text/javascript">
    function showExportOptions(){
        window.open("ExportOptions.html","diplayoptions","dependent=0,toolbar=0, menubar=0, title=0,location=0, status=0,scrollbars=0,resizable=0");
        return
    }
    function showOptions()
    {
        var name = prompt("EXCEL,CSV,HTML", "ENTER EXCEL OR CSV OR HTML");
        if(name=='HTML'){
            document.DDReportView.action="<%=strPost%>"
            document.DDReportView.submit();

        }
        if(name=='EXCEL'){
            document.DDReportView.action="getExcelreport.jsp"
            document.DDReportView.submit();
        }
        if(name=='CSV'){
            document.DDReportView.action="getExcelreport.jsp"
...
<FORM NAME="DDReportView" METHOD=POST ACTION="<%=strPost%>">

    <TABLE width="70%" align=center cellspacing=0 cellpadding=0 border=0>
        <TR><TD colspan=4>&nbsp;</TD></TR>
        <TR><TD align=center colspan=10>
                <SPAN CLASS="header1">A&nbsp;U&nbsp;T&nbsp;O&nbsp;M&nbsp;A&nbsp;T&nbsp;E&nbsp;D&nbsp;&nbsp;&nbsp;A&nbsp;C&nbsp;T&nbsp;I&nbsp;V&nbsp;I&nbsp;T&nbsp;Y&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;D&nbsp;A&nbsp;I&nbsp;L&nbsp;Y&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;D&nbsp;E&nbsp;T&nbsp;A&nbsp;I&nbsp;L&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;R&nbsp;E&nbsp;P&nbsp;O&nbsp;R&nbsp;T&nbsp;</SPAN></TD>
        </TR>
                                                            ...
                                                            <td align=right >Activity Type&nbsp;*&nbsp;:&nbsp;</td><td>
                                                                <select MULTIPLE NAME="ACTVTY_TYP_CD">
                                                                    ...
                                                                    <option value=<%= rs.getString("ACTVTY_TYP_CD")%> ><%= rs.getString("ACTVTY_TYP_DSCRPTN")%>
                                                                        ...
                                                                        <%  //added Simple Order Flag search field for Reports- Satish - 03/24/2011%>
                                                                    <TR><TD colspan=2>&nbsp;</TD></TR>
                                                                    <TR>
                                                                    ...
                                                                    <%
                                                                                    ...
                                                                                    rs.close();
                                                                                    rs = null;
                                                                                    Log.write(Log.ERROR, "AutoDetailDateSelect.jsp : Exception caught [" + e + "]");
                                                                                    stmt.close();
                                                                                    stmt = null;
                                                                                } finally {
                                                                    ...
                                                                    <%
                                                                                /** $Log:   //ACI-AIS-PVCS/SCM2PVCS/PVCS/ARCHIVES/express/JAVA/JSP/AutoDetailDateSelect.jsv  $
