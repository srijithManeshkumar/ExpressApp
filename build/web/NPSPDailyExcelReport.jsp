<%-- 
    Document   : NPSPDailyExcelReport
    Created on : May 24, 2011, 4:58:23 PM
    Author     : satish.t
--%>
...
<%
            ...
            response.setHeader("Content-Disposition", "attachment; filename=" + "NPSPDailyReport" + ".xls");
...
<table width=2100 border=1 align=center cellspacing=0 cellpadding=0>
...
String strQry = "SELECT t2.cus_typ AS CusTyp, t8.ci_clec AS CLEC, t3.eu_la_name AS CusName, t3.eu_la_sano AS SANO, " +
	...
	String supValue = "";
       ...
       while(rs.next())
       {
            ...
            if (strCusTyp == null) {strCusTyp = "&nbsp";}
                strCLEC = rs.getString("CLEC");
            if (strCLEC == null) {strCLEC = "&nbsp";}
       		strCusName = rs.getString("CusName");
            if (strCusName == null) {strCusName = "&nbsp";}
       		...
       		while(rs1.next())
                {
                     ...
                     if (strPorting == null) {strPorting = "&nbsp";}
                         strDisconn = rs1.getString(2);
                     if (strDisconn == null) {strDisconn = "&nbsp";}
%>
                <tr>
