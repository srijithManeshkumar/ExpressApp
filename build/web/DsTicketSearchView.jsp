...
<FORM NAME="DsTicketSearchView" METHOD=POST ACTION="DsTicketListCtlr?tcktsrch=advsrch">
...
<TABLE width=70% align=center cellspacing=0 cellpadding=0 border=0>
  ...
  <TR><TD colspan=2>&nbsp;</TD></TR>
  <TR>
	<TD align=right valign=top>Express&nbsp;Number:&nbsp;</TD>
...
/*
  <TR>
	...
	<TD align=left><input type=text maxLength=20 size=20 name=teleno><BR><BR></TD>
  </TR>
*/
%>

  <TR>
	<TD align=right valign=top>Trouble&nbsp;Ticket&nbsp;Number:</TD>
	<TD align=left><input type=text maxLength=20 size=20 name=tmsttno><BR><BR></TD>
  </TR>
  <TR>
	...
	<br>
	<%
	rsSrch = stmtSrch.executeQuery("SELECT STTS_CD FROM STATUS_T WHERE TYP_IND = 'S' ORDER BY STTS_CD ASC");
...
<%
//Took out per KPEN Christy McGuire
// <TR>
//	<TD align=right valign=top>Action&nbsp;Code:</TD>
//	<TD align=left><input type=text maxLength=30 size=30 name=actioncd><BR><BR></TD>
// </TR>
%>
