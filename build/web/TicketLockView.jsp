...
<%
	String strQuery = "SELECT TL.SQNC_NMBR, TL.USERID,  " +
		...
		" FROM LOCK_T TL, USERID_T u, TICKET_T T, ocn_t o " +
		" WHERE TL.USERID = U.USERID AND TL.SQNC_NMBR = T.TCKT_SQNC_NMBR AND TL.TYP_IND = 'T'" +
...
%>
		<TR>
			...
			<TD align=center><A HREF="TicketUnlockCtlr?tckt=<%=rs.getString(1)%>">&nbsp;Unlock&nbsp;Ticket&nbsp;</A></TD>
