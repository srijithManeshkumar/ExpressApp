    ...
    %>
        ...
        function checkValues()
        {
           if(document.pressed == 'Submit')
            {
                document.FFReportForm.action ="FulFillmntReport.jsp";
            }
            else
                if(document.pressed == 'EXCEL')
            {
                document.FFReportForm.action ="FulFillmntExcelReport.jsp";
            }else{
                document.FFReportForm.action ="FulFillmntReport.jsp";
            }
            // some form edits
    ...
    <body onLoad="setOrderTypSelect(FFReportForm.dwonew_prdcttyp, FFReportForm.dwonew_srvctyp);">
        <TABLE width=70% align=center cellspacing=0 cellpadding=0 border=0>
            ...
            <TR><TD align=center colspan=4>
                    <SPAN CLASS="header1">O&nbsp;R&nbsp;D&nbsp;E&nbsp;R &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;F&nbsp;U&nbsp;L&nbsp;F&nbsp;I&nbsp;L&nbsp;L&nbsp;M&nbsp;E&nbsp;N&nbsp;T&nbsp;&nbsp;&nbsp;&nbsp; R&nbsp;E&nbsp;P&nbsp;O&nbsp;R&nbsp;T</SPAN></TD>
            </TR>
            <TR><TD colspan=4>&nbsp;</TD></TR>
